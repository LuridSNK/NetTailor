...
namespace HttTailor.NamingConventions;

internal class JsonLowerSnakeCaseNamingPolicy : JsonNamingPolicy
{
    public override string ConvertName(string name)
    {
        ...
        return string.Create(estimatedLength, name, (chars, srcName) =>
        {
            ...
            for (int srcIndex = 0; srcIndex < srcName.Length; srcIndex++)
            {
                ...
                chars[targetIndex++] = char.ToLowerInvariant(currentChar);
            }
        });
#else
